...
public class ExchangeController {
  ...
  public void invite(@Validated @RequestBody ExchangeDomain exchangeDomain,
    ...
    exchange.setOriginType(CoinType.valueOf(exchangeDomain.getOriginType().name().toUpperCase()));
    exchange.setDestPrice(exchangeDomain.getDestPrice());
    exchange.setDestType(CoinType.valueOf(exchangeDomain.getDestType().name().toUpperCase()));
